...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const table = document.getElementById('medicinesTable'); // ID actualizado para coincidir con tu tabla
    ...
    searchInput.addEventListener('input', function() {
        ...
        tableRows.forEach(row => {
            ...
            for (let i = 1; i < cells.length; i++) { // Empezar desde 1 para omitir la columna de ID
